/* Segun la documentación para la estructura y nomenclatura:
  - Ubicación: Bunkers code: bunker_1
        variables: 
            Temperatura del Aire        code: bunker_1_temp     topic: kellys/variables/bunker_1_temp
            Humedad Relativa del Aire   code: bunker_1_hum      topic: kellys/variables/bunker_1_hum
            Sonda de temperatura 1      code: bunker_1_sonda_1  topic: kellys/variables/bunker_1_sonda_1
            Sonda de temperatura 2      code: bunker_1_sonda_2  topic: kellys/variables/bunker_1_sonda_2
            Sonda de temperatura 3      code: bunker_1_sonda_3  topic: kellys/variables/bunker_1_sonda_3
            Sonda de temperatura 4      code: bunker_1_sonda_4  topic: kellys/variables/bunker_1_sonda_4
...
void loop() {
  ...
  client.publish("kellys/variables/bunker_1_temp", String(temp.temperature).c_str(), true);
  client.publish("kellys/variables/bunker_1_hum", String(humidity.relative_humidity).c_str(), true);
  ...
  client.publish("kellys/variables/bunker_1_sonda_1", String(promedioSonda1).c_str(), true);
  client.publish("kellys/variables/bunker_1_sonda_2", String(promedioSonda2).c_str(), true);
  client.publish("kellys/variables/bunker_1_sonda_3", String(promedioSonda3).c_str(), true);
  client.publish("kellys/variables/bunker_1_sonda_4", String(promedioSonda4).c_str(), true);
